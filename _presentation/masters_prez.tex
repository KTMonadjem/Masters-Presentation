...
\begin{frame} \frametitle{New case study -- Sensor fusion}
	\begin{block}{The enforced policy in question}
		\begin{myitemize}
			\item L -- Object detected by the LiDAR
			\item O -- Object detected by the MNN
			\item C -- Confidence of the object detected by the MNN
		\end{myitemize}
		\vspace{-0.6cm}
		\begin{figure}[t]
			\centering
			...
			\resizebox{\textwidth}{!}{%
				\begin{tabular}{|l|l|l|l|l|l|}
					...
					\multicolumn{6}{|l|}{Number of misclassifications (\%)}                               \\ \hline
						Without the enforcer & 0.37   & 6.43    & 1.37        & 2.18                 & 10.35 \\ \hline
						With the enforcer    & 0.16   & 2.08    & 1.57        & 0.63                 & 4.44  \\ \hline
					\end{tabular}%
				}
				\caption{Table showing preliminary results of the AV prediction SNN}
				\label{tbl:snn-res}
			\end{table}
	\end{block}
\end{frame}
