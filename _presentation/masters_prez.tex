...
\begin{frame} \frametitle{Final thesis chapter -- Results}
	\begin{table}[h]
		...
		\caption{Original images, trained for 0 epochs}
		\label{tbl:sign-res1}
	\end{table}
	\begin{table}[h]
		\centering
		...
		\caption{Original images, trained for 10000 epochs}
...
\begin{frame} \frametitle{Final thesis chapter -- Results}
	\begin{table}[h]
		...
		\caption{Perturbed images, trained for 0 epochs}
	...
	\begin{table}[h]
		...
		\caption{Perturbed images, trained for 10000 epochs}
...
\begin{frame} \frametitle{Final thesis chapter -- Results summary}
	\begin{myitemize}
		\item Up to 45\% difference in accuracy between perturbed and unperturbed inputs.
		\item Enforcer improves system by 6\% with no input perturbations.
		\item Enforcer improves system by 43\% with input perturbations.
		\item When system is untrained, accuracy of the enforcer is the same as accuracy of the LiDAR.
		\item As network gets more trained, enforcer is less useful.
	\end{myitemize}
\end{frame}
