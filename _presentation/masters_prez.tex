...
\begin{frame} \frametitle{Results (cont.)}
	\begin{table}[h]
		\centering
...
\begin{frame}\frametitle{Meta neural networks}
	\begin{itemize}
		\item Using an ensemble of meta neural networks~\footcite{ensembleANN}, it was shown that the combined accuracy of 3 SANNs was greater than the accuracy of any one SANN.
